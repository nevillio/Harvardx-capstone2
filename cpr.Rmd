...
```{r fig.cap= "Distribution of no. of children by Education level"}
cpr_train %>% 
...
```{r fig.cap="Distribution of no. of children of women by Husband's Education level"}
cpr_train %>% 
...
|    With increased education level, couples tend to use contraceptives. As expected, most people using long term contraceptives have the highest education level.
...
|    Interestingly enough the husband's education level does not necessarily mean use of contraceptives, but again people using long-term contraceptives tend to be the highest level. This maybe because of the high cost of long term methods.
...
|    We see that Muslim couples are comparitively less likely to use contraceptives
